...
def process(dataset_name):
    dataset = dataset_name.split('/', -1)[-1]
    ...
    for video in videos:
        ...
        img_names = [x.split('\\')[-2:] for x in img_names]
        img_names = ['/'.join(x) for x in img_names]
        # tag
        if dataset in ['VOT2018', 'VOT2019']:
...
if __name__ == '__main__':
    dataset = 'C:/Users/USER/Desktop/3/VOT2016'
    process(dataset)